...
Je vous recommand egrandement de concevoir votre apcpliation sous la forme de composants, c'est à dire de fonctions qui renvoi un objet HTMLElement.


En paratant du principe que `pokemon_obj` soit le pokemon retoruné par l'API, voici un exemple de fonction qui créer un composant pokémon.
``` js
