...
```
3. Vous devriez arriver sur le shell MySQL, faites la commande suivante pour vérifier que la base de données app-database a bien été créée.
```sql
...
Cette route renvoie en body du texte HTML, la réponse HTTP brute ressemble à celle-ci.
