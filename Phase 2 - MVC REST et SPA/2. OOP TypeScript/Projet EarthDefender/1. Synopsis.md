...
## Concept du jeu
Ce jeu est une version simplifiée de *Space Invader* où un petit vaisseau spatial détruit des aliens pour protéger la Terre.

Les aliens se déplacent vers la Terre et lui font perdre des points de vie lors de leurs collisions.

Le joueur contrôle le vaisseau spatial, il se déplace latéralement. Il peut également tirer des missiles qui détruisent un alien lors de la collision.
...
Cette application a besoin d'une haute interactivité, il nous faudra donc JavaScript. Nous utiliserons également un Canvas HTML pour afficher le jeu.
...
| Tir du joueur | Le joueur tire des missiles qui détruisent un alien au contact | Les missiles vont tout droit vers le haut de l'écran. La touche espace tire un missile. Le joueur peut tirer à une cadence maximum de 200ms |
