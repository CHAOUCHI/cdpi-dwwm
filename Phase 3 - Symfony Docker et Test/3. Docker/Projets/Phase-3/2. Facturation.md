# Dockeriser le projet Symfony Facturation
...
- La documentation de Symfony indique comment dockeriser la partie PHP du framework grâce au repo de `dunglas` qui est un des mainteneurs de Symfony.
...
2. Finissez de conteneuriser le projet Facturation Reloaded
