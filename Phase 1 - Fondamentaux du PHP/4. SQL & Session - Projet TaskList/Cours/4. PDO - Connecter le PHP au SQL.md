...
## Exemple secondaire avec une table User
...
$request->execute([
    "Billy",
    password_hash("1234",PASSWORD_DEFAULT) // un mot de passe doit toujours être chiffé pour en rendre impossible sa lecture en cas de fuite de donnée.
]);
...
$new_user_id = $database->lastInsertedId();
