...
## Mise en place
Un CRUD est un ensemble de fonctions d'accès a une table de données. Il est d'usage de séparer ces fonctions dans un autres rochiers pour s'en servir partout dans le projet comme bon nous semble.
